...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ-𝐂ʜᴀᴛ**: [|| ˹Bunny 𝗪ᴏʀʟᴅ˼ ||](t.me/Dreamy_dates)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇs**: [𝗔𝗟𝗣𝗛𝗔](t.me/Dreamy_dates)\n"
        f"└• **𝐌ᴀsᴛᴇʀ**: [BUNNY](t.me/Bunny_0131)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/YUKIKO426/bunny_userbot\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/YUKIKO426")
